  ...
  return (
    <div className="max-w-4xl mx-auto p-8 mt-16 bg-white shadow-lg rounded-lg border border-gray-200">
      ...
      <ul className="list-disc ml-8 text-gray-600 space-y-3">
        ...
        <li><strong>🔐 User Authentication:</strong> Secure login, registration, and account management</li>
      ...
      <ul className="list-disc ml-8 text-gray-600 space-y-3">
        ...
        <li><strong>🗄️ SQLite:</strong> Reliable database storage</li>
      </ul>
      
      <h2 className="text-3xl font-semibold mt-8 mb-4 text-gray-700 border-b pb-2">🌍 Live Demo & Code</h2>
      <p className="text-gray-600 text-lg">
        🔗 <a href="https://ecommerce-website-oeek.onrender.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline font-semibold">Live Demo</a>
        <br />
        📂 <a href="https://github.com/Smeet23/Ecommerce-Website" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline font-semibold">GitHub Repository</a>
      </p>
    </div>
  );
};
